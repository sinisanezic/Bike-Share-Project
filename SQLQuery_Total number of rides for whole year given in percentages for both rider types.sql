...
Note: We could complete this query without using CAST function. However, the result was given with extra zeroes in percentage column.
      To remove extra zeroes, we use CAST function to cast the result of the ROUND function to DECIMAL (10, 2). 
      The DECIMAL (10, 2) means that there will be a maximum of 10 digits with 2 of them representing decimal places.
